...
>
    ...
    <div className="flip-card-inner">
      ...
      <strong><h> TECHS:</h></strong>
      <ul>
          <li id="meee">
          Front-End  [ jQuery, Materialize ]
          </li>
          <li id="meee">
          API/s=[ CoinGecko ]
          </li>
   ...
   <div className="flip-card">
    <div className="flip-card-inner">
      <div className="flip-card-front"
            style={{backgroundImage:`url(${card2})`,backgroundRepeat:"no-repeat",backgroundSize:"cover"}}

      >
     <strong> <div
     style={{color:"white"}}
     >Coffee Crew</div></strong>
      </div>
      <div className="flip-card-back">
     <span
     style={{color:"white"}}
     > -First Freelance Work. fully functioning E-Commerce platform using stripe for payment processing.</span>
<br/>
      <strong><h> TECHS:</h></strong>
      <ul>
          <li id="meee">
      ...
      <small>** actually gonna use this as a template, so i've written the backend Using Sequelize/MySQL as well</small><br/>
  ...
  <div className="flip-card">
    <div className="flip-card-inner">
      <div className="flip-card-front"
            style={{backgroundImage:`url(${card3})`,backgroundRepeat:"no-repeat",backgroundSize:"cover"}}

      >
     <strong> <div
     style={{color:"white"}}
     >Feed Your Lifestyle</div></strong>
      </div>
      <div className="flip-card-back">
     <span
     style={{color:"white"}}
